...
$(document).ready(function(){
	...
	//未答题提前
	function YinitScollTop(){
//		console.log($(this).offset().top)
//		console.log($(document).scrollTop())
		if($('.Yactive:first').offset().top > $(document).scrollTop()){
			$(document).scrollTop($('.Yactive:first').offset().top - 200);
		}
	}
	...
	//未答题点击隐藏状态
	$(document).on('click','.Yactive',function (){
		$(this).removeClass('Yactive').find('img').hide();
	});
